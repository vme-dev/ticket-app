...
export default function (props) {
	...
	return (
		...
		<ul className='menu_transfer_list'>
			...
			<li className={"transfer_item " + (props.store.all?"action":"")} data-transfer="all" onClick={(e)=>{props.onClickAll(a)}}>
				<span className="transfer_checkbox"><i class="fas fa-check"></i></span><span className="curr_text">All</span>
			</li>
			<li className={"transfer_item " + (props.store.transferArr[0]&&!props.store.all?"action":"")} data-transfer="0" onClick={(e)=>{props.onClick(a,"0")}}>
			...
			<li className={"transfer_item " + (props.store.transferArr[1]&&!props.store.all?"action":"")} data-transfer="1" onClick={(e)=>{props.onClick(a,"1")}}>
			...
			<li className={"transfer_item " + (props.store.transferArr[2]&&!props.store.all?"action":"")} data-transfer="2" onClick={(e)=>{props.onClick(a,"2")}}>
			...
			<li className={"transfer_item " + (props.store.transferArr[3]&&!props.store.all?"action":"")} data-transfer="3" onClick={(e)=>{props.onClick(a,"3")}}>
